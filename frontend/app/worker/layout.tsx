...
export default function WorkerLayout({
  ...
  if (loading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-background">
        <div className="text-muted-foreground text-sm">Caricamento sessione protetta...</div>
      </main>
    )
  }
  ...
  // Frontend Route Protection: Show Unauthorized if user is not a worker
      ...
      <main className="flex min-h-screen items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md border-destructive/30">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Questa sezione è riservata esclusivamente ai lavoratori di cantiere.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="p-3 bg-muted rounded-md text-xs text-muted-foreground space-y-1">
              <div>Ruolo Utente Attuale: <strong className="text-foreground">Ispettore di Vigilanza</strong></div>
